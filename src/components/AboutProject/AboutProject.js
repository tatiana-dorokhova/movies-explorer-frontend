  ...
  return (
    <section className="about-project">
      ...
      <div className="about-project__stages">
        <div className="about-project__stage about-project_dark">
          <div className="about-project__stage">1 неделя</div>
          <div className="about-project__caption">Back-end</div>
        </div>
        <div className="about-project__stage about-project_light">
          <div className="about-project__stage">4 недели</div>
